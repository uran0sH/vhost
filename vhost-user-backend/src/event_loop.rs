...
mod tests {
    ...
    fn test_vring_epoll_handler() {
        ...
        handler
            .register_listener(consumer.as_raw_fd(), Interest::READABLE, 3)
            .unwrap();
        ...
        handler
            .register_listener(consumer.as_raw_fd(), Interest::READABLE, 1)
            .unwrap_err();

        handler
            .unregister_listener(consumer.as_raw_fd(), Interest::READABLE, 3)
            .unwrap();
        ...
        handler
            .unregister_listener(consumer.as_raw_fd(), Interest::READABLE, 1)
            .unwrap_err();
